  ...
  function getSnapshot(options) {
    ...
    const snapshot = {
      ...
      customer: {
        ...
        firstName: stringValue(report?.consumer?.firstName || report?.profile?.firstName),
        lastName: stringValue(report?.consumer?.lastName || report?.profile?.lastName),
        email: stringValue(report?.consumer?.email || report?.profile?.email),
        phone: stringValue(report?.consumer?.phone || report?.profile?.phone)
      },
      assessment: {
